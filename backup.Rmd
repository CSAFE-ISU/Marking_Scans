...
for(i in 1:nrow(df_1_0)){
  ...
  df_1_0$x3pmin[[i]] <- min(df_1_0$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_0)){
  
  df_1_0$x3pmax[[i]] <- max(df_1_0$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_0)){
  
  df_1_0$chop_storage[[i]]$surface.matrix <- (df_1_0$chop_storage[[i]]$surface.matrix - df_1_0$x3pmin[[i]])/(df_1_0$x3pmax[[i]]- df_1_0$x3pmin[[i]])*255
...
#df_1$x3p[[1]]$surface.matrix %>% unlist() %>% as.vector() %>% summary()
#x3pmin <- min(df_1$x3p[[1]]$surface.matrix, na.rm=TRUE) 
# <- max(df_1$x3p[[1]]$surface.matrix, na.rm=TRUE) #Save
#df_1$x3p[[1]]$surface.matrix <- (df_1$x3p[[1]]$surface.matrix - x3pmin)/(x3pmax-x3pmin)*255
#df_1_0 <- df_1_0 %>% chop(c(chop_storage, labels))
...
for(i in 1:nrow(df_1_1)){
  ...
  df_1_1$x3pmin[[i]] <- min(df_1_1$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_1)){
  
  df_1_1$x3pmax[[i]] <- max(df_1_1$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_1)){
  
  df_1_1$chop_storage[[i]]$surface.matrix <- (df_1_1$chop_storage[[i]]$surface.matrix - df_1_1$x3pmin[[i]])/(df_1_1$x3pmax[[i]]- df_1_1$x3pmin[[i]])*255
...
for(i in 1:nrow(df_1_2)){
  ...
  df_1_2$x3pmin[[i]] <- min(df_1_2$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_2)){
  
  df_1_2$x3pmax[[i]] <- max(df_1_2$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_2)){
  
  df_1_2$chop_storage[[i]]$surface.matrix <- (df_1_2$chop_storage[[i]]$surface.matrix - df_1_2$x3pmin[[i]])/(df_1_2$x3pmax[[i]]- df_1_2$x3pmin[[i]])*255
...
for(i in 1:nrow(df_1_3)){
  ...
  df_1_3$x3pmin[[i]] <- min(df_1_3$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_3)){
  
  df_1_3$x3pmax[[i]] <- max(df_1_3$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_3)){
  
  df_1_3$chop_storage[[i]]$surface.matrix <- (df_1_3$chop_storage[[i]]$surface.matrix - df_1_3$x3pmin[[i]])/(df_1_3$x3pmax[[i]]- df_1_3$x3pmin[[i]])*255
...
for(i in 1:nrow(df_1_4)){
  ...
  df_1_4$x3pmin[[i]] <- min(df_1_4$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_4)){
  
  df_1_4$x3pmax[[i]] <- max(df_1_4$chop_storage[[i]]$surface.matrix, na.rm = TRUE)
  
}

for(i in 1:nrow(df_1_4)){
  
  df_1_4$chop_storage[[i]]$surface.matrix <- (df_1_4$chop_storage[[i]]$surface.matrix - df_1_4$x3pmin[[i]])/(df_1_4$x3pmax[[i]]- df_1_4$x3pmin[[i]])*255
...
```{r}
df_1_0 <- df_1_0 %>% unnest(c(x3pmin, x3pmax, labels)) #Unlist
...
df_1_0$labels[df_1_0$labels == "#1F376CFF"] <- 5
df_1_0$labels[df_1_0$labels == "#FF0080FF"] <- 6
...
```{r}
df_1_1 <- df_1_1 %>% unnest(c(x3pmin, x3pmax, labels)) #Unlist
...
df_1_1$labels[df_1_1$labels == "#1F376CFF"] <- 5
df_1_1$labels[df_1_1$labels == "#FF0080FF"] <- 6
...
```{r}
df_1_2 <- df_1_2 %>% unnest(c(x3pmin, x3pmax, labels)) #Unlist
...
df_1_2$labels[df_1_2$labels == "#1F376CFF"] <- 5
df_1_2$labels[df_1_2$labels == "#FF0080FF"] <- 6

unique(df_1_2$labels)
...
```{r}
df_1_3 <- df_1_3 %>% unnest(c(x3pmin, x3pmax, labels)) #Unlist
...
df_1_3$labels[df_1_3$labels == "#1F376CFF"] <- 5
df_1_3$labels[df_1_3$labels == "#FF0080FF"] <- 6

unique(df_1_3$labels)
...
df_1_4 <- df_1_4 %>% unnest(c(x3pmin, x3pmax, labels)) #Unlist
...
df_1_4$labels[df_1_4$labels == "#1F376CFF"] <- 5
df_1_4$labels[df_1_4$labels == "#FF0080FF"] <- 6
...
model_1 <- keras_model_sequential() %>%
  layer_conv_3d(filters = 32, kernel_size = c(3, 3, 1), padding = "same", activation = "relu",  kernel_initializer='he_uniform', input_shape = c(128, 128, 1, 1)) %>% 
  ...
  layer_dropout(0.5) %>%
  layer_conv_3d(filters = 64, kernel_size = c(3, 3, 1), activation = "relu", kernel_initializer='he_uniform') %>%
  layer_max_pooling_3d(pool_size = c(2, 2, 1)) %>%
  layer_batch_normalization(center = TRUE, scale = TRUE) %>%
  layer_dropout(0.5) %>%
  layer_flatten() %>%
  layer_dense(units = 256, activation = "relu", kernel_initializer='he_uniform') %>%
  layer_dense(units = 256, activation = "relu", kernel_initializer='he_uniform')%>%
...
array_1_x <- abind(array_1_0, array_1_1, array_1_2, array_1_3, array_1_4, along=1)

y_1_x <- rbind(y_1_0, y_1_1, y_1_2, y_1_3, y_1_4)

#array_1_x[is.na(array_1_x)] = 0
...
model_1 %>% fit(
  array_1_x, y_1_x, epochs = 3, batch_size = 256, validation_split = 0.2
)
